...
from ramifice.errors import (InvalidDate, InvalidDateTime)
...
class TestGlobalTools(unittest.TestCase):
    ...
    def test_tools_datetime_parse(self):
        ...
        # Negative:
        self.assertRaises(InvalidDateTime, datetime_parse, '1/1/2024')
        self.assertRaises(InvalidDateTime, datetime_parse, '2024/1/1')
        self.assertRaises(InvalidDateTime, datetime_parse, '1.1.2024')
        self.assertRaises(InvalidDateTime, datetime_parse, '1/1/2024')
        self.assertRaises(InvalidDateTime, datetime_parse, '1/1/2024 09:33:15')
        self.assertRaises(InvalidDateTime, datetime_parse, '2024/1/1 09:33:15')
        self.assertRaises(InvalidDateTime, datetime_parse, '1.1.2024 09:33:15')
        self.assertRaises(InvalidDateTime, datetime_parse, '1/1/2024 09:33:15')
        self.assertRaises(InvalidDateTime, datetime_parse, '1/1/2024T09:33:15')
        self.assertRaises(InvalidDateTime, datetime_parse, '2024/1/1T09:33:15')
        self.assertRaises(InvalidDateTime, datetime_parse, '1.1.2024T09:33:15')
        self.assertRaises(InvalidDateTime, datetime_parse, '1/1/2024T09:33:15')
        # Positive:
