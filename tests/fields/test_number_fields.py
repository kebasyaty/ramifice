...
class TestNumberFields(unittest.TestCase):
    ...
    def test_integer_field(self):
        ...
        self.assertEqual(f.html_attrs["field_type"], "IntegerField")
        ...
        self.assertEqual(f.html_attrs["group"], "number")
        self.assertEqual(f.html_attrs["input_type"], "number")
        ...
        self.assertIsNone(f.html_attrs["max_number"])
        self.assertIsNone(f.html_attrs["min_number"])
        self.assertEqual(f.html_attrs["step"], 1)
        # Exception checking:
    ...
    def test_float_field(self):
        ...
        self.assertEqual(f.html_attrs["label"], "")
        self.assertEqual(f.html_attrs["name"], "")
        self.assertEqual(f.html_attrs["field_type"], "FloatField")
        self.assertFalse(f.html_attrs["disabled"])
        self.assertFalse(f.html_attrs["hide"])
        self.assertFalse(f.html_attrs["ignored"])
        self.assertIsNone(f.html_attrs["warning"])
        ...
        self.assertIsNone(f.html_attrs["max_number"])
        self.assertIsNone(f.html_attrs["min_number"])
        self.assertEqual(f.html_attrs["step"], float(1))
        # Exception checking:
        with self.assertRaises(AssertionError):
