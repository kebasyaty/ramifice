...
class TestTextFields(unittest.TestCase):
    ...
    def test_url_field(self):
        ...
        f = URLField()
        self.assertEqual(f.id, "")
        self.assertEqual(f.label, "URL address")
        self.assertEqual(f.name, "")
        ...
        self.assertIsNone(f.value)
        self.assertIsNone(f.default)
        self.assertEqual(f.placeholder, "Enter URL address")
        self.assertEqual(f.hint, "Enter URL address")
        self.assertFalse(f.required)
        self.assertFalse(f.readonly)
        self.assertFalse(f.unique)
        # Exception checking:
    ...
    def test_slug_field(self):
        ...
        self.assertEqual(f.input_type, "text")
        self.assertIsNone(f.value)
        self.assertEqual(f.placeholder, "It is added automatically")
        self.assertEqual(f.hint, "It is added automatically")
        self.assertFalse(f.required)
        self.assertFalse(f.readonly)
        self.assertTrue(f.unique)
        self.assertEqual(f.slug_sources, ["_id"])
    ...
    def test_phone_field(self):
        ...
        f = PhoneField()
        self.assertEqual(f.id, "")
        self.assertEqual(f.label, "Phone number")
        self.assertEqual(f.name, "")
        ...
        self.assertIsNone(f.value)
        self.assertIsNone(f.default)
        self.assertEqual(f.placeholder, "Enter phone number")
        self.assertEqual(f.hint, "Enter phone number")
        self.assertFalse(f.required)
        self.assertFalse(f.readonly)
        self.assertFalse(f.unique)
        # Exception checking:
    ...
    def test_password_field(self):
        ...
        f = PasswordField()
        self.assertEqual(f.id, "")
        self.assertEqual(f.label, "Password")
        self.assertEqual(f.name, "")
        ...
        self.assertIsNone(f.value)
        self.assertEqual(f.placeholder, "Enter password")
        self.assertEqual(f.hint, "Enter password")
        self.assertFalse(f.required)
        # Methods:
        self.assertFalse(f.is_valid())
    ...
    def test_ip_field(self):
        ...
        f = IPField()
        self.assertEqual(f.id, "")
        self.assertEqual(f.label, "IP address")
        self.assertEqual(f.name, "")
        ...
        self.assertIsNone(f.value)
        self.assertIsNone(f.default)
        self.assertEqual(f.placeholder, "Enter IP address")
        self.assertEqual(f.hint, "Enter IP address")
        self.assertFalse(f.required)
        self.assertFalse(f.readonly)
        self.assertFalse(f.unique)
        # Exception checking:
    ...
    def test_color_field(self):
        ...
        f = ColorField()
        self.assertEqual(f.id, "")
        self.assertEqual(f.label, "Color")
        self.assertEqual(f.name, "")
        ...
        self.assertEqual(f.placeholder, "Enter color code")
        self.assertEqual(f.hint, "Enter color code")
        self.assertFalse(f.required)
        self.assertFalse(f.readonly)
        self.assertFalse(f.unique)
        # Exception checking:
