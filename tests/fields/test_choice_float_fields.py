...
class TestChoiceFloatFields(unittest.TestCase):
    ...
    def test_choice_float_field(self):
        ...
        self.assertEqual(f.field_attrs.field_type, "ChoiceFloatField")
        ...
        self.assertTrue(f.has_value())
        f.field_attrs.value = 2.0
        self.assertTrue(f.has_value())
        f.field_attrs.value = 3.0
    ...
    def test_choice_float_mult_field(self):
        ...
        self.assertEqual(f.field_attrs.label, "")
        self.assertEqual(f.field_attrs.name, "")
        self.assertEqual(f.field_attrs.field_type, "ChoiceFloatMultField")
        self.assertFalse(f.field_attrs.disabled)
        self.assertFalse(f.field_attrs.hide)
        self.assertFalse(f.field_attrs.ignored)
        self.assertEqual(len(f.field_attrs.warning), 0)
    ...
    def test_choice_float_dyn_field(self):
        ...
        self.assertEqual(f.field_attrs.label, "")
        self.assertEqual(f.field_attrs.name, "")
        self.assertEqual(f.field_attrs.field_type, "ChoiceFloatDynField")
        self.assertFalse(f.field_attrs.disabled)
        self.assertFalse(f.field_attrs.hide)
        self.assertFalse(f.field_attrs.ignored)
        self.assertEqual(len(f.field_attrs.warning), 0)
    ...
    def test_choice_float_mult_dyn_field(self):
        ...
        self.assertEqual(f.field_attrs.label, "")
        self.assertEqual(f.field_attrs.name, "")
        self.assertEqual(f.field_attrs.field_type, "ChoiceFloatMultDynField")
        self.assertFalse(f.field_attrs.disabled)
        self.assertFalse(f.field_attrs.hide)
        self.assertFalse(f.field_attrs.ignored)
        self.assertEqual(len(f.field_attrs.warning), 0)
