...
class TestModel(unittest.TestCase):
    ...
    def test_instance_user(self):
        ...
        self.assertEqual(m.username__core.id, "id-username")
        self.assertEqual(m.username__core.name, "username")
    ...
    def test_instance_user_profile(self):
        ...
        self.assertEqual(m.profession__core.id, "id-profession")
        self.assertEqual(m.profession__core.name, "profession")
