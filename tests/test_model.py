...
class TestModel(unittest.TestCase):
    ...
    def test_instance_model(self):
        ...
        self.assertTrue(m.id__core.hide)
        self.assertTrue(m.id__core.disabled)
        ...
        self.assertTrue(m.created_at__core.hide)
        self.assertTrue(m.created_at__core.disabled)
        ...
        self.assertTrue(m.updated_at__core.hide)
        self.assertTrue(m.updated_at__core.disabled)
