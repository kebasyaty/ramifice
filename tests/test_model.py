...
class TestModel(unittest.TestCase):
    ...
    def test_instance_model(self):
        ...
        self.assertEqual(m.id__core.label, "Идентификатор документа")
        self.assertEqual(m.id__core.placeholder, "Он добавляется автоматически")
        self.assertEqual(m.id__core.hint, "Он добавляется автоматически")
        self.assertEqual(len(m.id__core.warning), 0)
        self.assertTrue(m.id__core.is_hide)
        self.assertTrue(m.id__core.is_disable)

        self.assertEqual(m.created_at__core.label, "Создан")
        self.assertEqual(m.created_at__core.placeholder, "Он добавляется автоматически")
        self.assertEqual(m.created_at__core.hint, "Он добавляется автоматически")
        self.assertEqual(m.created_at__core.warning[0], "Когда был создан документ.")
        self.assertTrue(m.created_at__core.is_hide)
        self.assertTrue(m.created_at__core.is_disable)

        self.assertEqual(m.updated_at__core.label, "Обновлен")
        self.assertEqual(m.updated_at__core.placeholder, "Он добавляется автоматически")
        self.assertEqual(m.updated_at__core.hint, "Он добавляется автоматически")
        self.assertEqual(m.updated_at__core.warning[0], "Когда был обновлен документ.")
        self.assertTrue(m.updated_at__core.is_hide)
        self.assertTrue(m.updated_at__core.is_disable)
